...
ChatLogic::ChatLogic()
{
    //// STUDENT CODE
    ////
    /* remove chatbot ownership from chat logic*/
    /*
...
ChatLogic::~ChatLogic()
{
    ...
    */
    // delete all nodes
    /* no need to handle memory management of nodes and edges anymore */
    /*
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        //// STUDENT CODE
                        ////
                        /* Changes to adapt with nodes unique pointers */
                    ...
                    if (type->second == "EDGE")
                    {
                        //// STUDENT CODE
                        ////
                        /* Changes to adapt with edges unique pointers */
